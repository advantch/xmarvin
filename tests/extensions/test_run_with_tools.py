...
from marvin.extensions.utilities.thread_runner import handle_assistant_run, handle_local_run, run_context, verify_runtime_config
...
async def test_remote_agent(start_run_payload, mocker):
    ...
    assert data.agent_config is not None, "Agent config is required: Did you forget to call `verify_runtime_config?`"
